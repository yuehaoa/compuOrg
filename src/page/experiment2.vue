                    ...
                    <div v-show="!centerDialogVisible">
                        ...
                        <div class="pc-ar box">                     
                            <div class="wrapper">
                                ...
                                <div class="pcar-D7-D0 eightNeedle" @click="buttonClick('pcarD7D0')" id="pcarD7D0"/>
                                <div class="pcar-D7-D0-text text">
                                    D7-------D0
                                </div>
                                <div class="pcar-LDAR twoNeedle" @click="buttonClick('pcarLDAR')" id="pcarLDAR"/>
                                <div class="pcar-LDAR-text text">
                                    LDAR
                                </div>
                                <div class="pcar-LDPC twoNeedle" @click="buttonClick('pcarLDPC')" id="pcarLDPC"/>
                                <div class="pcar-LDPC-text text">
                                    LDPC
                                </div>
                                <div class="pcar-PC-B twoNeedle" @click="buttonClick('pcarPCB')" id="pcarPCB"/>
                                <div class="pcar-PC-B-text text">
                                    PC_B
                                </div>
                        ...
                        <div class="mm box">
                            <div class="wrapper">
                                ...
                                <div class="mem-D7-D0 eightNeedle" @click="buttonClick('memD7D0')" id="memD7D0"/>
                                <div class="mem-D7-D0-text text">
                                    D7--D0
                                </div>
                                <div class="mem-A7-A0 eightNeedle" @click="buttonClick('memA7A0')" id="memA7A0"/>
                                <div class="mem-A7-A0-text text">
                                    A7--A0
                                </div>
                                <div class="mem-WR-RD fourNeedle" @click="buttonClick('memWRRD')" id="memWRRD"/>
                                <div class="mem-WR-RD-text text">
                                    WR-RD
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="in-unit box">
                            <div class="wrapper">
                                ...
                                <div class="IN-B-RD fourNeedle" @click="buttonClick('IN_B-RD')" id="IN_B-RD"/>
                                <div class="IN-B-RD-text text">
                                    IN_B-RD
                                </div>
                                <div class="IN-D7-D0 eightNeedle" @click="buttonClick('inD7D0')" id="inD7D0"/>
                                <div class="IN-D7-D0-text text">
                                    D7-------D0
                                </div>
                                <div class="IN-D7 switch" @click="changeSwitch"/>
                                <div class="IN-D6 switch" @click="changeSwitch"/>
                                <div class="IN-D5 switch" @click="changeSwitch"/>
                                <div class="IN-D4 switch" @click="changeSwitch"/>
                                <div class="IN-D3 switch" @click="changeSwitch"/>
                                <div class="IN-D2 switch" @click="changeSwitch"/>
                                <div class="IN-D1 switch" @click="changeSwitch"/>
                                <div class="IN-D0 switch" @click="changeSwitch"/>
                                <div class="IN-D7D3-text text">
                                    D7<br><br><br><br> D3
                                </div>
                                <div class="IN-D4D0-text text">
                                    D4 <br><br><br><br> D0
                                </div>
                            </div>
                        </div>
